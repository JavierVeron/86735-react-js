        ...
        <>
            <div className="container-fluid mt-5">
                <div className="row">
                    ...
                    <div className="col">
                        <img src="https://mcd-landings-l-statics.appmcdonalds.com/uploads-live/Familias_5_5c08103cc1.webp" alt="Familia" className="img-fluid" />
                    </div>
                </div>
            </div>
            ...
            <div className="container-fluid my-5">
                <div className="row">
                    <div className="col-md-3 offset-md-1">
                        <img src="https://mcd-landings-l-statics.appmcdonalds.com/uploads-live/Familias_3_9069939334.webp" alt="Familia #2" className="img-fluid" />
                    </div>
                    <div className="col-md-5 d-flex align-items-center">
                        <div>
                            <h2 className="fw-bold">Cajita Feliz · Pioneros en fomentar la lectura infantil.</h2>
            ...
            <div className="container-fluid my-5">
                <div className="row">
                    <div className="col-md-5 offset-md-1 d-flex align-items-center">
                        <div>
                            <h2 className="fw-bold">Compromiso con la Nutrición</h2>
                    ...
                    <div className="col-md-4">
                        <img src="https://mcd-landings-l-statics.appmcdonalds.com/uploads-live/Familias_4_32008c28a7.webp" alt="Familia #3" className="img-fluid" />
                    </div>
                </div>
            </div>
            <div className="container-fluid my-5">
                <div className="row">
                    <div className="col-md-4 offset-md-1">
                        <img src="https://mcd-landings-l-statics.appmcdonalds.com/uploads-live/Familia_1_154e670acb.webp" alt="Familia #4" className="img-fluid" />
                    </div>
                    <div className="col-md-5 d-flex align-items-center">
                        <div>
                            <h2 className="fw-bold">Casa Ronald McDonald’s</h2>
