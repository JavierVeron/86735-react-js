                    ...
                    <table className="table">
                        <tbody>
                                ...
                                cart.map(item => (
                                    <tr key={item.id}>
                                        ...
                                        <td className="align-middle text-center">
                                            <button className="btn btn-warning btn-sm" onClick={() => {decrementarItem(item.id)}}><i className="bi bi-dash"></i></button> ${item.price * item.quantity} <button className="btn btn-warning btn-sm" onClick={() => {aumentarItem(item.id, item.stock)}}><i className="bi bi-plus"></i></button>
                                        </td>
                            ...
                            <tr>
                                ...
                                <td className="text-end"><Link to={"/checkout"} className="btn btn-warning btn-sm fw-bold">Checkout</Link></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
